...
export const title = "Create Next Project";
const description =
  "Create Next Project starts your progressive web app off with a perfect Google Lighthouse score.";
const url = `https://create-next-project.now.sh`;
